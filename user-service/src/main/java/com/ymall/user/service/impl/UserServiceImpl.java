...
import com.ymall.api.client.CartClient;
...
import com.ymall.common.exception.ForbiddenException;
import com.ymall.common.utils.UserContext;
import com.ymall.user.config.JwtProperties;
import com.ymall.user.domain.po.User;
import com.ymall.user.domain.vo.UserLoginVO;
import com.ymall.user.enums.UserStatus;
import com.ymall.user.mapper.UserMapper;
import com.ymall.user.service.IUserService;
import com.ymall.user.utils.JwtTool;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public UserLoginVO login(LoginFormDTO loginDTO) {
        ...
        vo.setToken(token);
        vo.setCartItemCount(cartClient.queryMyCartsCount(user.getId()).getData());
        return vo;
    }
